<%@ Page Title="" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="AdminProducts.aspx.vb" Inherits="admin_AdminProducts" %>
            ...
            <asp:GridView ID="MyProducts" runat="server" CssClass="col-sm-12" BorderStyle="None" GridLines="Horizontal" CellPadding="5" ForeColor="Black" EmptyDataText="Du har ikke opprettet noen anmeldelser." AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ProductsDataSource" PageSize="10">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Forfatter" SortExpression="Brukernavn" >
                        <ItemTemplate>
                            <asp:LinkButton Id="Forfatter" runat="server" CssClass="link" Width="40px" Text='<%# Eval("Brukernavn")%>' PostBackUrl='<%# Eval("Brukernavn", "~/Profile.aspx?Usr={0}") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-Width="20px" ItemStyle-HorizontalAlign="Right">
                        <ItemTemplate>
                            <asp:LinkButton Id="DeleteProduct" runat="server" CssClass="link" CommandName="Delete" Text="&times;" OnClientClick="return confirm('Vennligst bekreft sletting av anmeldelse. Denne handlingen kan ikke angres.')"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
