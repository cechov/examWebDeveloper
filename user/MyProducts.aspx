<%@ Page Title="" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="MyProducts.aspx.vb" Inherits="user_MyProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="ProductsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:TacoHeavenConnectionString %>" 
        SelectCommand="SELECT * FROM [Product] LEFT JOIN [Styrke] ON [Product].[Styrke] = [Styrke].[SpiceID] LEFT JOIN [Kategori] ON [Product].[Kategori] = [Kategori].[CategoryID] WHERE ([Brukernavn] = @Brukernavn) ORDER BY [ProductID] DESC">
        <SelectParameters>
